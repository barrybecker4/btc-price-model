...
import { MINING_COST_FLOOR_STEP, miningCostFloorBounds, START_PRICE_SLIDER_STEP } from "../utils/startPriceSlider.js";
import { C, FONT_HEAD, FONT_NUM, FONT_UI } from "../theme.js";
import { fmtUSD, safeDivide } from "../utils/format.js";
    ...
    <>
        ...
        <Slider
          ...
          onChange={(v) => {
            setP((prev) => ({
              ...prev,
              circulatingSupply: v,
              alreadyLostCoins: Math.min(prev.alreadyLostCoins, Math.min(7_000_000, Math.floor(v * 0.9))),
            }));
          }}
      ...
      >
        {[
          ...
          ["Demand ratio", `${safeDivide(strcInitialDayBtc, 450, 0).toFixed(1)}×`, C.red],
